...
namespace MVC.Areas.Admin.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public DepartmentController(IWebHostEnvironment webHost, IHttpApiService httpApiService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //vm.Users = users;
            vm.Deparment = departmentResponse.Data;
            vm.Hospital = hospitalResponse.Data;
            return View(vm);
        }
